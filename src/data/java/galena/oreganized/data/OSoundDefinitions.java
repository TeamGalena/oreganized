...
public class OSoundDefinitions extends SoundDefinitionsProvider {
    ...
    public void registerSounds() {
        ...
        add(OSoundEvents.TARNISH, definition().with(
                sound(Oreganized.MOD_ID + ":block/tarnish_1"),
                sound(Oreganized.MOD_ID + ":block/tarnish_2"),
                sound(Oreganized.MOD_ID + ":block/tarnish_3"),
                sound(Oreganized.MOD_ID + ":block/tarnish_4"),
                sound(Oreganized.MOD_ID + ":block/tarnish_5")
        ).subtitle("subtitles.block.tarnish"));

        add(OSoundEvents.POLISH, definition().with(
                sound(Oreganized.MOD_ID + ":block/polish_1"),
                sound(Oreganized.MOD_ID + ":block/polish_2"),
                sound(Oreganized.MOD_ID + ":block/polish_3"),
                sound(Oreganized.MOD_ID + ":block/polish_4")
        ).subtitle("subtitles.block.polish"));

        add(OSoundEvents.POLISH_FINISH, definition().with(
                sound(Oreganized.MOD_ID + ":block/polish_finish_1"),
                sound(Oreganized.MOD_ID + ":block/polish_finish_2"),
                sound(Oreganized.MOD_ID + ":block/polish_finish_3"),
                sound(Oreganized.MOD_ID + ":block/polish_finish_4"),
                sound(Oreganized.MOD_ID + ":block/polish_finish_5")
        ));
    }
}
