package galena.oreganized.glance.world.structure;

import com.mojang.serialization.Codec;
import com.mojang.serialization.MapCodec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import galena.oreganized.OConstants;
import galena.oreganized.glance.index.GlanceStructures;
...
public class BoulderStructure extends Structure {
    ...
    public @NotNull Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (structurePiecesGenerator.isPresent()) {
            ...
            OConstants.LOGGER.log(Level.DEBUG, "Boulder at {}", blockPos);
        }
    ...
    public StructureType<?> type() {
        return GlanceStructures.BOULDER.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
