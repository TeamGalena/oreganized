package galena.oreganized.plumbum.client.render.gui;
...
public class StunningOverlay implements LayeredDraw.Layer {
    ...
    public void render(GuiGraphics graphics, DeltaTracker delta) {
        ...
        var stunning = minecraft.player.getEffect(PlumbumEffects.STUNNING);
        ...
        if (minecraft.player.isEyeInFluidType(PlumbumFluids.MOLTEN_LEAD_TYPE.get()))
