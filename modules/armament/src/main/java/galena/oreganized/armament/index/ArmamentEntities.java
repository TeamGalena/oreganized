...
public class ArmamentEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ShrapnelBomb>> SHRAPNEL_BOMB = ENTITIES.createEntity("shrapnel_bomb",
            ShrapnelBomb::new,
            MobCategory.MISC,
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LeadBoltEntity>> LEAD_BOLT = ENTITIES.createEntity(
            ...
            LeadBoltEntity::new,
            MobCategory.MISC,
            builder -> builder.sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20).build("lead_bolt")
    );
