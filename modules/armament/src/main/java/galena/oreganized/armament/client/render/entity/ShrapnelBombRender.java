package galena.oreganized.armament.client.render.entity;
...
public class ShrapnelBombRender extends EntityRenderer<ShrapnelBomb> {
    ...
    public void render(ShrapnelBomb entity, float yaw, float paritalTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        ...
        poseStack.mulPose(Axis.YP.rotationDegrees(90.0F));
        TntMinecartRenderer.renderWhiteSolidBlock(blockRenderer, ArmamentBlocks.SHRAPNEL_BOMB.get().defaultBlockState(), poseStack, buffer, packedLight, fuse / 5 % 2 == 0);
        poseStack.popPose();
